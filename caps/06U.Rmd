...
A grandes rasgos, los distintos enfoques que hemos reseñado en esta sección pueden ilustrarse en el Gráfico siguientes gráficas:  

```{r grusky, fig.cap= "Tipos de representación de la estructura social (Grusky, 2008): 1) Régimen de clase, 2) Régimen gradacional, 3) Desigualdad desorganizada", fig.align='center', out.width = '80%', echo=FALSE}
...
```{r, message=FALSE, warning=FALSE, fig.cap= "Ingresos totales individuales por clase social", fig.width= 6, fig.asp= 0.8, echo=TRUE}
