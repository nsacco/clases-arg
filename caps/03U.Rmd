...
```{r censos1, fig.cap="Variables económicas de la población en los censos modernos. Argentina, 1947-2010", echo=FALSE, warning=FALSE, message=FALSE}
...
```{r censos2, fig.cap="Sistemas clasificatorios de las variables económicas de la población en los censos modernos. Argentina, 1947-2010", echo=FALSE, warning=FALSE, message=FALSE}
